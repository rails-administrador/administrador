...
Gem::Specification.new do |s|
  ...
  s.add_dependency "rao-query",                ">= 0.0.14.pre"
  s.add_dependency "rao-component",            ">= 0.0.14.pre"
  s.add_dependency "rao-resource_controller",  ">= 0.0.14.pre"
  s.add_dependency "rao-resources_controller", ">= 0.0.14.pre"
  s.add_dependency "rao-service_controller",   ">= 0.0.14.pre"
